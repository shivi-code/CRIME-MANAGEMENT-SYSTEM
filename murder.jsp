<html>
    ...
    <body>
         <h1 style="color:red"><font size="6"><u>MURDER FIR</u></font></h1>
        <div class="login-box">
         <form action="murderDBMS.jsp" method="post">
     ...
     Complaint Id &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="id" /><br><br> 
      ...
      Murder Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="datetime-local" name="datentime" /><br><br> 
       Murder Location&nbsp;&nbsp;&nbsp;&nbsp; <select name="location">
          <option>--Select Murder Location--</option>
      ...
      Evidence&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="file" name="Evidence"  /><br><br><br>
